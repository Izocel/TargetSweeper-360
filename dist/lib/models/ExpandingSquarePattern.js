...
class ExpandingSquarePattern extends BaseModel_1.BaseModel {
    ...
    updateTargets() {
        ...
        for (let legNumber = 1; legNumber <= maxLegs; legNumber++) {
            ...
            const endPosition = GeoCalculator_1.GeoCalculator.offsetTarget(this.datum, Math.sqrt(rotatedX * rotatedX + rotatedY * rotatedY), Math.atan2(rotatedX, rotatedY) * 180 / Math.PI);
